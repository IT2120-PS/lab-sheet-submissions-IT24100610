setwd("C:\\Users\\IT24100610\\Desktop\\IT24100610Lab05")
getwd()
#Q1
...
##Creating  "for" loop to assign classes of the frequency distribution into "Classes" variable
...
plot (breaks, new, type = '7', main = "Cumulative Frequency Polygon for deliver times", xlab = "Shareholders", ylab = "Cumulative Frequency", yim = cCO, max (cum. freq)))|
